        ...
        <div className="port_wrap">
          <article className="port_item p1">
            ...
            <div className="desc">
              ...
              Distinctio atque, aspernatur error itaque sit dolorum provident
              officiis quam impedit modi excepturi aperiam cumque iste minus
            </div>
            <a
              href="/"
              target="_blank"
          ...
          <article className="port_item p2">
            ...
            <div className="desc">
              222 Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Distinctio atque,
            </div>
            <a
              href="/"
          ...
          <article className="port_item p3">
            ...
            <div className="desc">
              333 Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Distinctio atque, aspernatur error itaque sit dolorum provident
              officiis quam impedit modi excepturi aperiam cumque iste minus
              optio corrupti fugiat, recusandae mollitia?
            </div>
            <a
              href="/"
              target="_blank"
          ...
          <article className="port_item p6">
            ...
            <div className="desc">
              666 Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Distinctio atque, aspernatur error itaque sit dolorum provident
              officiis quam impedit modi excepturi aperiam cumque iste minus
              optio corrupti fugiat, recusandae mollitia?
            </div>
